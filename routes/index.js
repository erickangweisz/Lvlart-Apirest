...
api.get('/images/:number/userid/:userId', imageCtrl.getXimagesByUserId)
...
api.post('/user/:userId/uploadavatar', userCtrl.uploadAvatar)
api.post('/user/:userId/uploadimghead', userCtrl.uploadImgHead)
...
api.get('/duels/:number/category/:category', duelCtrl.getXduelsByCategory)
...
api.get('/duels/:number/userid/:userId', duelCtrl.getXduelsByUserId)
